...
//}
//
//void cp(HARD_DISK* disk, char* fichier1, char* fichier2){
//    int blockFile, fileSize, i, j;
//    char* data;
//
//    if(fileExists(disk, fichier1)){
//        for(i=0; i<NB_PARTITIONS; i++) {
//            for(j=0;j<DISK_SIZE;j++) {
//                if(disk->partitions[i].tabBlocksData[j].fichier.fileName == fichier1) {
//                    blockFile = j;
//                    fileSize = disk->partitions[i].tabBlocksData[blockFile].fichier.fileSize;
//                    data = disk->partitions[i].tabBlocksData[blockFile].fichier.donnees[0];
//                }
//        writeFile(disk, createFile(disk, fichier2, fileNumber, fileSize, 1, data), fileSize, data);
//            }
//        }
//    }
//}
